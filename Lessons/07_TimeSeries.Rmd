...
# Inspect results
wind_data_trend1
summary(wind_data_trend1) # since p-value is less than .05 we have a trend and reject the null hypothesis of no trend. 


wind_data_trend2 <- trend::smk.test(wind_data_ts)
# Inspect results
wind_data_trend2
summary(wind_data_trend2) # overall decreasing trend
