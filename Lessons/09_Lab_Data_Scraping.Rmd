...
```{r pull.and.plot.discharge.data}
#Set the URL change the gage number and period from 7 to 24
...
TG Class Notes: look at robots.txt files to understand if you are allowed to scrape a site or not. or if they have a terms of service doc (developer terms of service). 
...
#TG Notes: need to sign up for a census key and then import our key into the code above in order to get this code below to work. 
...
"Price" = as.numeric(the_price),
"Capacity" = as.numeric(gsub(",","",the_capacity)),
"Generation" = gsub(",","",net_generation),
"Total_retail" = gsub(",","",total_retail)
)


#html nodes grads the specific nested tags you want from the html view source of the website.
```
