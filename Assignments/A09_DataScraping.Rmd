...
Withdrawls.scrape.function <- function(any_year, pswid_number){
  ...
  new.dataframe <- data.frame("Water System Name" = water.system.name.new,
                              "PSWID" = pswid.new,
                              "Ownership" = ownership.new,
                              "Max Withdrawls Total" = as.numeric(max.withdrawals.mgd.new),
                              "Max Withdrawls Month" = max.withdrawls.month.new,
                              "Max Withdrawls Year" = max.withdrawls.year.new,
                              "Date" = as.Date(my(paste(max.withdrawls.month.new, "-",
...
#plot 2 just in case
ggplot(durham.2015.withdrawls,aes(x=max.withdrawls.month,y=max.withdrawals.mgd)) + 
  geom_point() +
  labs(title = paste("2020 Max Withdrawls for", water.system.name),
       subtitle = paste("PSWID", pswid),
       y="Max Withdrawls",
