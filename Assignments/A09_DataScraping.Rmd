...
Withdrawls.scrape.function <- function(any_year, pswid_number){
  ...
  new.dataframe <- new.dataframe %>% mutate("Date_New" = my(paste(Max_Withdrawls_Month, "-",
                                                        Max_Withdrawls_Year)))
...
ggplot(durham.2015.withdrawls) +
  ...
  labs(title = paste("2015 Max Withdrawls for", water.system.name),
...
#plot
ggplot(asheville.2015.withdrawls) +
...
ggplot() + 
geom_line(data=durham.2015.withdrawls, aes(x=Date_New, y=Max_Withdrawls_Total), color='green') + 
geom_line(data=asheville.2015.withdrawls, aes(x=Date_New, y=Max_Withdrawls_Total), color='yelow') +
  labs(title = paste("2015 Max Withdrawls for", durham.2015.withdrawls$water.system.name, asheville.2015.withdrawls$water.system.name),
       subtitle = paste("PSWID", durham.2015.withdrawls$PSWID, asheville.2015.withdrawls$PSWID),
       y="Max Withdrawls",
       x="Month")


#after spending over 10 hours on this assignment, reviewing lessons, lab notes, and slack I was unable to finish. I kept running into more and more errors with the function reading both the durham and asheville sites. Unfortunately I cannot spend any more time on this assignment and need to move on to other classwork. 
