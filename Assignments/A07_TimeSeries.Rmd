...
>Answer: Looking at the plot, you can see a slight downward trend in Ozone concenration over time. This indicates that there is some type of relationship and seasonality may be a factor. 
...
> Answer: Based on the Mann Kendall test, the P-value is significant (less than .05) - this means that we can beleive that there is a relationship between ozone concentration and trends over time. 
